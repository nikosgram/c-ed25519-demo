...
static int compressMessage(uint64_t *state, const unsigned char *buf) {
    ...
    for (i = 16; i < 80; i++) {
        ...
        w[i] = ((((a & UI64_MAX) >> 19 | a << 45) & UI64_MAX) ^ (((a & UI64_MAX) >> 61 | a << 3) & UI64_MAX) ^
                ((a & UI64_MAX) >> 6)) + w[i - 7] +
               ((((b & UI64_MAX) >> 1 | b << 63) & UI64_MAX) ^ (((b & UI64_MAX) >> 8 | b << 56) & UI64_MAX) ^
                ((b & UI64_MAX) >> 7)) + w[i - 16];
    }

    for (i = 0; i < 80; i += 8) {
        // A LOT OF BYTE SHIFTING
        t0 = s[7] + ((((s[4] & UI64_MAX) >> 14 | s[4] << 50) & UI64_MAX) ^
                     (((s[4] & UI64_MAX) >> 18 | s[4] << 46) & UI64_MAX) ^
                     (((s[4] & UI64_MAX) >> 41 | s[4] << 23) & UI64_MAX)) + (s[6] ^ (s[4] & (s[5] ^ s[6]))) + K[i] +
             w[i];
        s[3] += t0;
        s[7] = t0 + (((((s[0] & UI64_MAX) >> 28 | s[0] << 36) & UI64_MAX) ^
                      (((s[0] & UI64_MAX) >> 34 | s[0] << 30) & UI64_MAX) ^
                      (((s[0] & UI64_MAX) >> 39 | s[0] << 25) & UI64_MAX)) + ((s[0] | s[1]) & s[2] | s[0] & s[1]));

        t0 = s[6] + ((((s[3] & UI64_MAX) >> 14 | s[3] << 50) & UI64_MAX) ^
                     (((s[3] & UI64_MAX) >> 18 | s[3] << 46) & UI64_MAX) ^
                     (((s[3] & UI64_MAX) >> 41 | s[3] << 23) & UI64_MAX)) + (s[5] ^ (s[3] & (s[4] ^ s[5]))) + K[i + 1] +
             w[i + 1];
        s[2] += t0;
        s[6] = t0 + (((((s[7] & UI64_MAX) >> 28 | s[7] << 36) & UI64_MAX) ^
                      (((s[7] & UI64_MAX) >> 34 | s[7] << 30) & UI64_MAX) ^
                      (((s[7] & UI64_MAX) >> 39 | s[7] << 25) & UI64_MAX)) + ((s[7] | s[0]) & s[1] | s[7] & s[0]));

        t0 = s[5] + ((((s[2] & UI64_MAX) >> 14 | s[2] << 50) & UI64_MAX) ^
                     (((s[2] & UI64_MAX) >> 18 | s[2] << 46) & UI64_MAX) ^
                     (((s[2] & UI64_MAX) >> 41 | s[2] << 23) & UI64_MAX)) + (s[4] ^ (s[2] & (s[3] ^ s[4]))) + K[i + 2] +
             w[i + 2];
        s[1] += t0;
        s[5] = t0 + (((((s[6] & UI64_MAX) >> 28 | s[6] << 36) & UI64_MAX) ^
                      (((s[6] & UI64_MAX) >> 34 | s[6] << 30) & UI64_MAX) ^
                      (((s[6] & UI64_MAX) >> 39 | s[6] << 25) & UI64_MAX)) + ((s[6] | s[7]) & s[0] | s[6] & s[7]));

        t0 = s[4] + ((((s[1] & UI64_MAX) >> 14 | s[1] << 50) & UI64_MAX) ^
                     (((s[1] & UI64_MAX) >> 18 | s[1] << 46) & UI64_MAX) ^
                     (((s[1] & UI64_MAX) >> 41 | s[1] << 23) & UI64_MAX)) + (s[3] ^ (s[1] & (s[2] ^ s[3]))) + K[i + 3] +
             w[i + 3];
        s[0] += t0;
        s[4] = t0 + (((((s[5] & UI64_MAX) >> 28 | s[5] << 36) & UI64_MAX) ^
                      (((s[5] & UI64_MAX) >> 34 | s[5] << 30) & UI64_MAX) ^
                      (((s[5] & UI64_MAX) >> 39 | s[5] << 25) & UI64_MAX)) + ((s[5] | s[6]) & s[7] | s[5] & s[6]));

        t0 = s[3] + ((((s[0] & UI64_MAX) >> 14 | s[0] << 50) & UI64_MAX) ^
                     (((s[0] & UI64_MAX) >> 18 | s[0] << 46) & UI64_MAX) ^
                     (((s[0] & UI64_MAX) >> 41 | s[0] << 23) & UI64_MAX)) + (s[2] ^ (s[0] & (s[1] ^ s[2]))) + K[i + 4] +
             w[i + 4];
        s[7] += t0;
        s[3] = t0 + (((((s[4] & UI64_MAX) >> 28 | s[4] << 36) & UI64_MAX) ^
                      (((s[4] & UI64_MAX) >> 34 | s[4] << 30) & UI64_MAX) ^
                      (((s[4] & UI64_MAX) >> 39 | s[4] << 25) & UI64_MAX)) + ((s[4] | s[5]) & s[6] | s[4] & s[5]));

        t0 = s[2] + ((((s[7] & UI64_MAX) >> 14 | s[7] << 50) & UI64_MAX) ^
                     (((s[7] & UI64_MAX) >> 18 | s[7] << 46) & UI64_MAX) ^
                     (((s[7] & UI64_MAX) >> 41 | s[7] << 23) & UI64_MAX)) + (s[1] ^ (s[7] & (s[0] ^ s[1]))) + K[i + 5] +
             w[i + 5];
        s[6] += t0;
        s[2] = t0 + (((((s[3] & UI64_MAX) >> 28 | s[3] << 36) & UI64_MAX) ^
                      (((s[3] & UI64_MAX) >> 34 | s[3] << 30) & UI64_MAX) ^
                      (((s[3] & UI64_MAX) >> 39 | s[3] << 25) & UI64_MAX)) + ((s[3] | s[4]) & s[5] | s[3] & s[4]));

        t0 = s[1] + ((((s[6] & UI64_MAX) >> 14 | s[6] << 50) & UI64_MAX) ^
                     (((s[6] & UI64_MAX) >> 18 | s[6] << 46) & UI64_MAX) ^
                     (((s[6] & UI64_MAX) >> 41 | s[6] << 23) & UI64_MAX)) + (s[0] ^ (s[6] & (s[7] ^ s[0]))) + K[i + 6] +
             w[i + 6];
        s[5] += t0;
        s[1] = t0 + (((((s[2] & UI64_MAX) >> 28 | s[2] << 36) & UI64_MAX) ^
                      (((s[2] & UI64_MAX) >> 34 | s[2] << 30) & UI64_MAX) ^
                      (((s[2] & UI64_MAX) >> 39 | s[2] << 25) & UI64_MAX)) + ((s[2] | s[3]) & s[4] | s[2] & s[3]));

        t0 = s[0] + ((((s[5] & UI64_MAX) >> 14 | s[5] << 50) & UI64_MAX) ^
                     (((s[5] & UI64_MAX) >> 18 | s[5] << 46) & UI64_MAX) ^
                     (((s[5] & UI64_MAX) >> 41 | s[5] << 23) & UI64_MAX)) + (s[7] ^ (s[5] & (s[6] ^ s[7]))) + K[i + 7] +
             w[i + 7];
        s[4] += t0;
        s[0] = t0 + (((((s[1] & UI64_MAX) >> 28 | s[1] << 36) & UI64_MAX) ^
                      (((s[1] & UI64_MAX) >> 34 | s[1] << 30) & UI64_MAX) ^
                      (((s[1] & UI64_MAX) >> 39 | s[1] << 25) & UI64_MAX)) + ((s[1] | s[2]) & s[3] | s[1] & s[2]));
    }
